...
int *my_int_malloc(int count) {
    int *result = (int *) PyMem_Malloc(count * sizeof(int));
    if (!result) {
        PyErr_SetString(PyExc_MemoryError, "Failed to allocate memory");
        return result;
    }
...
%apply (int DIM1, char OUT_STRING[ANY]) {(int lenout,
                                          char frname[256])};
%apply (int *OUT_BOOLEAN) {int *found};
...
%apply (double OUT_ARRAY1[ANY]) {double dc[128]};
...
%apply (double RETURN_DOUBLE)  {double dvnorm_c};

extern double dvnorm_c (
        double state[6]);
...
%apply (double IN_ARRAY1[ANY]) {double s1[6]};
%apply (double IN_ARRAY1[ANY]) {double s2[6]};
%apply (double RETURN_DOUBLE)  {double dvsep_c};

extern double dvsep_c (
        double s1[6],
        double s2[6]);
...
%apply (char *CONST_STRING) {char *trmtyp};
%apply (char *CONST_STRING) {char *source};
%apply (char *CONST_STRING) {char *target};
%apply (char *CONST_STRING) {char *fixref};
%apply (char *CONST_STRING) {char *abcorr};
%apply (char *CONST_STRING) {char *obsrvr};
%apply (double *OUTPUT) {double *trgepc};
%apply (double OUT_ARRAY1[ANY]) {double obspos[3]};
%apply (double **OUT_ARRAY2, int *SIZE1, int *SIZE2)
                    {(double **trmpts, int *dim1, int *dim2)};
%apply (void RETURN_VOID) {void my_edterm_c};

/* Helper function to deal with order of arguments */
%inline %{
    void my_edterm_c(char *trmtyp, char *source, char *target,
                     double et, char *fixref, char *abcorr, char *obsrvr,
                     int npts, double *trgepc, double obspos[3],
                     double **trmpts, int *dim1, int *dim2) {

        double *result = my_malloc(npts * 3);
        if (!result) return;
...
%apply (double  IN_ARRAY1[ANY]) {double eqel[9]};
%apply (double OUT_ARRAY1[ANY]) {double state[6]};
...
%apply (char *CONST_STRING) {char *ltype};
%apply (int *OUTPUT) {int *hr};
%apply (int *OUTPUT) {int *mn};
%apply (int *OUTPUT) {int *sc};
...
%inline %{
    void my_et2lst_c(double et, int body, double lon, char *ltype,
...
%apply (char    *CONST_STRING) {char *inst};
%apply (double IN_ARRAY1[ANY]) {double raydir[3]};
%apply (char    *CONST_STRING) {char *rframe};
%apply (char    *CONST_STRING) {char *abcorr};
%apply (char    *CONST_STRING) {char *observer};
%apply (void      RETURN_VOID) {void my_fovray_c};

/* Helper function deals with et passed by pointer not value */

%inline %{
    void my_fovray_c(char *inst, double raydir[3], char *rframe, char *abcorr,
                     char *observer, double et, int *visible) {
...
%apply (char *CONST_STRING) {char *inst};
%apply (char *CONST_STRING) {char *target};
%apply (char *CONST_STRING) {char *tshape};
%apply (char *CONST_STRING) {char *tframe};
%apply (char *CONST_STRING) {char *abcorr};
%apply (char *CONST_STRING) {char *observer};
%apply (void   RETURN_VOID) {void my_fovtrg_c};
...
%inline %{
    void my_fovtrg_c(char *inst, char *target, char *tshape, char *tframe,
                     char *abcorr, char *observer, double et, int *visible) {
...
%apply (int DIM1, char OUT_STRING[ANY]) {(int shapelen, char shape[256])};
%apply (int DIM1, char OUT_STRING[ANY]) {(int framelen, char frame[256])};
%apply (double         OUT_ARRAY1[ANY]) {double bsight[3]};
%apply (int *SIZE1, int *SIZE2, double OUT_ARRAY2[ANY][ANY])
                          {(int *size1, int *size2, double bounds[1000][3])};
%apply (void RETURN_VOID) {void my_getfov_c};

/* Helper function to deal with order of arguments */
%inline %{
    void my_getfov_c(int instid,
...
%apply (double IN_ARRAY1[ANY])  {double spoint[3]};
%apply (double OUT_ARRAY1[ANY]) {double srfvec[3]};
...
%apply (char *CONST_STRING) {char *method};
%apply (char *CONST_STRING) {char *target};
%apply (char *CONST_STRING) {char *fixref};
%apply (double IN_ARRAY2[1][2], int DIM1)
                            {(double lonlat[1][2], int npts)};
%apply (double **OUT_ARRAY2, int *SIZE1, int *SIZE2)
                            {(double **srfpts, int *sdim1, int *sdim2)};
%apply (void RETURN_VOID)   {void my_latsrf_c};

/* Helper function to deal with order of arguments */
%inline %{
    void my_latsrf_c(char *method, char *target, double et, char *fixref,
                     double *lonlat, int npts,
                     double **srfpts, int *sdim1, int *sdim2) {

        double *srfpts1 = my_malloc(npts * 3);
        if (!srfpts1) {
            return;
        }
...
%apply (char    *CONST_STRING) {char *fixref};
%apply (char    *CONST_STRING) {char *abcorr};
%apply (char    *CONST_STRING) {char *corloc};
%apply (char    *CONST_STRING) {char *obsrvr};
%apply (double IN_ARRAY1[ANY]) {double refvec[3]};

%apply (int    **OUT_ARRAY1, int *SIZE1)
                               {(int **npts, int *ndim1)};
%apply (double **OUT_ARRAY2, int *SIZE1, int *SIZE2)
                               {(double **points, int *pdim1, int *pdim2)};
%apply (double **OUT_ARRAY1, int *SIZE1)
                               {(double **epochs, int *edim1)};
%apply (double **OUT_ARRAY2, int *SIZE1, int *SIZE2)
                               {(double **tangts, int *tdim1, int *tdim2)};

%apply (void RETURN_VOID) {void my_limbpt_c};

/* Helper function to deal with order of arguments */
%inline %{
    void my_limbpt_c(char *method, char *target, double et,
                     char *fixref, char *abcorr, char *corloc, char *obsrvr,
                     double refvec[3], double rolstp, int ncuts,
                     double schstp, double soltol, int maxn,
                     int **npts, int *ndim1,
                     double **points, int *pdim1, int *pdim2,
                     double **epochs, int *edim1,
                     double **tangts, int *tdim1, int *tdim2) {
        ...
        npts1 = my_int_malloc(maxn);
        points1 = my_malloc(maxn * 3);
        epochs1 = my_malloc(maxn);
        tangts1 = my_malloc(maxn * 3);
...
%apply (double  IN_ARRAY1[ANY]) {double state[6]};
%apply (double OUT_ARRAY1[ANY]) {double elts[11]};
...
%apply (char *CONST_STRING) {char *pck};
%apply (double OUT_ARRAY2[ANY][ANY], int *SIZE1)
                        {(double array[500][2], int *intervals)};
...
%inline %{
    /* Helper function to create a 2-D array of results */
    void my_pckcov_c(char *pck, int idcode,
                     double array[500][2], int *intervals) {
...
%apply (double RETURN_DOUBLE) {double phaseq_c};

extern double phaseq_c (
        double et,
        char *CONST_STRING,
        char *CONST_STRING,
        char *CONST_STRING,
...
%apply (int DIM1, double IN_ARRAY2[ANY][ANY]) {(int nv, double vrtces[1][3])};
%apply (int DIM1,    int IN_ARRAY2[ANY][ANY]) {(int np, int plates[1][3])};
%apply (double RETURN_DOUBLE) {double pltar_c};

extern double pltar_c (
        int nv, double vrtces[1][3],
        int np, int plates[1][3]);
...
%apply (double  IN_ARRAY2[ANY][ANY]) {double iverts[3][3]};
%apply (double OUT_ARRAY2[ANY][ANY]) {double overts[3][3]};
...
%apply (int DIM1, double IN_ARRAY2[ANY][ANY]) {(int nv, double vrtces[1][3])};
%apply (int DIM1,    int IN_ARRAY2[ANY][ANY]) {(int np, int plates[1][3])};
%apply (double RETURN_DOUBLE) {double pltvol_c};

extern double pltvol_c (
        int nv, double vrtces[1][3],
        int np, int plates[1][3]);
...
%apply (double  IN_ARRAY1[ANY]) {double stobs[6]};
%apply (double  IN_ARRAY1[ANY]) {double accobs[6]};
%apply (double OUT_ARRAY1[ANY]) {double starg[6]};
...
%apply (double IN_ARRAY1[ANY]) {double stobs[6]};
%apply (double IN_ARRAY1[ANY]) {double starg[6]};
...
%apply (int DIM1, char OUT_STRING[ANY]) {(int srflen, char srfstr[256])}
%apply (void RETURN_VOID) {void srfc2s_c};

extern void srfc2s_c (
        int code,
        int bodyid,
        int srflen, char srfstr[256],
        int *OUT_BOOLEAN);
...
%apply (char *CONST_STRING) {char *target};
%apply (char *CONST_STRING) {char *fixref};
%apply (int DIM1, double IN_ARRAY2[ANY][ANY]) {(int npts, double srfpts[1][3])};
%apply (double **OUT_ARRAY2, int *SIZE1, int *SIZE2)
                    {(double **normls, int *dim1, int *dim2)};
%apply (void RETURN_VOID) {void my_srfnrm_c};

/* Helper function to deal with order of arguments */
%inline %{
    void my_srfnrm_c(char *method, char *target, double et, char *fixref,
                     int npts, double srfpts[1][3],
                     double **normls, int *dim1, int *dim2) {
...
%apply (double   IN_ARRAY1[ANY]) {double stvrtx[6]};
%apply (double   IN_ARRAY1[ANY]) {double stdir[6]};
%apply (double  OUT_ARRAY1[ANY]) {double stx[6]};
...
%apply (int DIM1, char OUT_STRING[ANY]) {(int lenout, char action[256])};
