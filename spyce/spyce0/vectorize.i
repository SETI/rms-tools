...
* handles that sequence of arguments. Inside the file spyce0.i, each function is vectorized by executing one of these macros, which
* then expands into the needed inline source code.
***********************************************************************************************************************************/

/***********************************************************************************************************************************
* spyce0/vectorize_header.txt
*
* This file contains the header information for SWIG file vectorize.i. It defines the typemaps used by all the spyce0 vectorized
* functions.
*
